...
class PeriodChooserWidget(ttk.Frame):
    def __init__(self, master=None, **kw):
        ...
        self.lbl_inter_from.grid(column='0', padx='10', row='1', rowspan='2', sticky='e')
        ...
        self.lbl_inter_to.grid(column='2', padx='10', row='1', rowspan='2', sticky='e')
        self.lbl_inter_to.rowconfigure('1', pad='0')
        ...
        self.cal_inter_to.rowconfigure('1', pad='0')
        
        self.spr_inter = ttk.Separator(self)
        self.spr_inter.configure(orient='vertical')
        self.spr_inter.grid(column='4',pady ='10', padx='15', row='0', rowspan='3', sticky='ns')
        self.spr_inter.rowconfigure('0', pad='0')
        ...
        self.rbn_inter_week.grid(column='5', padx='10', pady='10', row='1', sticky='ew')
        ...
        self.rbn_inter_month.grid(column='6', padx='10', row='1', sticky='ew')
        ...
        self.rbn_inter_year.grid(column='7', padx='10', row='1', sticky='ew')
        ...
        self.btn_inter_prev.grid(column='5', padx='10', pady='5', row='2', sticky='ew')
        self.btn_inter_prev.rowconfigure('2', pad='0')
        ...
        self.btn_inter_current.grid(column='6', padx='10', row='2', sticky='ew')
        self.btn_inter_current.rowconfigure('2', pad='0')
        ...
        self.rbn_inter_next.grid(column='7', padx='10', row='2', sticky='ew')
        self.rbn_inter_next.rowconfigure('2', pad='0')
        ...
        self.lbl_inter_chooseperiod.grid(column='5', columnspan='6', pady='5', row='0')
        self.lbl_inter_chooseperiod.rowconfigure('0', pad='0')
        ...
        self.lbl_inter_enterinterval.grid(column='0', columnspan='4', pady='5', row='0')
        self.lbl_inter_enterinterval.rowconfigure('0', pad='0')
