...
class PeriodChooserWidget(ttk.Frame):
    def __init__(self, master=None, **kw):
        ...
        self.spr_inter.grid(column='2', padx='25', row='0', rowspan='3', sticky='ns')
        ...
        self.lbl_inter_enterinterval.grid(column='0', columnspan='2', pady='5', row='0')
        ...
        self.lbfrm_pr_inter.grid(column='0', ipadx='10', padx='10', pady='5', row='0', sticky='new')
